...
Проверяется корректность фильтрации транзакций по валюте USD.

Проверяется, что возвращается пустой результат, если нет транзакций с заданной валютой.

Проверяется работа с пустым списком транзакций.

- Тесты для transaction_descriptions:

Проверяется, что возвращаются корректные описания операций.

Проверяется работа с пустым списком транзакций.

- Тесты для card_number_generator:

Проверяется корректность генерации номеров карт в заданном диапазоне.
